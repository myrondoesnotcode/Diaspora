...
export const EPOCHS: Epoch[] = [
  ...
  {
    name: 'Russian Pale Era',
    startYear: 1791,
    endYear: 1881,
    color: '#16a085',
    description: 'Catherine the Great confines Russian Jews to the Pale of Settlement; 5 million Jews live under tsarist restriction until pogroms explode in 1881.',
    longDescription: 'When Russia absorbed the Polish-Lithuanian Commonwealth through three partitions (1772–1795), it suddenly became home to the world\'s largest Jewish population — people it had never wanted. Empress Catherine the Great\'s solution was the Pale of Settlement (December 1791): a vast territory of ~500,000 square miles stretching from the Baltic to the Black Sea where Jews were legally confined. By 1897, nearly 5 million Jews lived within its borders — 40% of world Jewry — crowded into small towns (shtetlakh), barred from owning land, and periodically stripped of even their limited rights. Nicholas I forcibly conscripted Jewish boys into 25-year military service to break their religious identity. Alexander II briefly liberalized, permitting wealthy merchants and university graduates to live outside the Pale — producing a generation of assimilated Jewish professionals in Moscow and St. Petersburg. But his assassination in 1881 ended that experiment abruptly, and the May Laws of 1882 tightened restrictions further. The Pale became a pressure cooker: overcrowded, impoverished, and increasingly radicalized — fertile ground for Zionism, socialism, and mass emigration.',
    keyEvents: [
      { year: 1791, label: 'Catherine the Great establishes the Pale of Settlement; ~1 million Jews confined to former Polish territory' },
      { year: 1827, label: 'Nicholas I institutes the Cantonist system: Jewish boys conscripted for 25-year military service to force assimilation' },
      { year: 1855, label: 'Alexander II liberalizes; wealthy merchants, graduates, and artisans permitted to reside outside the Pale' },
      { year: 1871, label: 'First major Odessa pogrom — 6 killed, 800+ buildings destroyed; inspires proto-Zionist thought in Leo Pinsker and others' },
      { year: 1880, label: 'Pale of Settlement holds ~4 million Jews — 40% of world Jewry — in conditions of chronic poverty and legal discrimination' },
    ],
    notableFigures: [
      { name: 'Leo Pinsker', years: '1821–1891', role: 'Odessa physician who wrote *Auto-Emancipation* (1882) after the 1871 pogrom, arguing Jews must seek their own territory — a precursor to Herzl\'s Zionism' },
      { name: 'Sholem Yankev Abramovitsh (Mendele)', years: '1836–1917', role: 'Father of modern Yiddish literature; his satires of Pale life captured both its warmth and its degradation' },
      { name: 'Emma Lazarus', years: '1849–1887', role: 'American Jewish poet who wrote "The New Colossus" (engraved on the Statue of Liberty) in response to the 1881 pogroms and the flood of refugees' },
    ],
    geographicCenter: 'Pale of Settlement (Eastern Europe)',
    sources: [
      'Zipperstein, Steven J., *Pogrom: Kishinev and the Tilt of History*, 2018',
      'Frankel, Jonathan, *Prophecy and Politics: Socialism, Nationalism, and the Russian Jews 1862–1917*, 1981',
      'Klier, John D., *Russians, Jews, and the Pogroms of 1881–1882*, 2011',
    ],
  ...
  },
  {
    ...
    endYear: 1924,
    color: '#27ae60',
    description: 'Pogroms and poverty propel ~2.5 million Jews from Eastern Europe to the Americas and Palestine; the Johnson-Reed Act of 1924 slams the door.',
    longDescription: 'Czar Alexander II\'s assassination in 1881 unleashed a wave of pogroms across the Russian Pale of Settlement that triggered the largest Jewish migration in history. Over four decades, more than 2.5 million Jews left the Pale — a region covering parts of today\'s Ukraine, Belarus, Poland, and Lithuania — for new lives in the Americas and Palestine. About 80% reached the United States. New York\'s Lower East Side became the world\'s largest Jewish city by 1910, its streets a cacophony of Yiddish, ambition, and labor organizing. The 1905 Revolution triggered a second, deadlier pogrom wave across 660 towns, sending 200,000 more refugees westward in a single year. At the same time, Zionist pioneers (the First, Second, and Third Aliyot) began draining swamps, founding kibbutzim, and reviving Hebrew as a spoken language in Ottoman and British Palestine. The era ended abruptly when the Johnson-Reed Immigration Act (1924) essentially closed America\'s doors to Eastern European Jews — a decision whose consequences would prove catastrophic two decades later.',
    keyEvents: [
      { year: 1881, label: 'Russian pogroms begin after Alexander II\'s assassination; mass emigration accelerates' },
      { year: 1882, label: 'First Aliyah to Palestine begins; May Laws further tighten Pale restrictions' },
      { year: 1897, label: 'First Zionist Congress in Basel; Theodor Herzl founds the World Zionist Organization' },
      { year: 1903, label: 'Kishinev pogrom (49 killed, 600+ raped) shocks world opinion; Bialik\'s poem galvanizes Jewish consciousness' },
      { year: 1905, label: '1905 pogrom wave: 660+ towns attacked; ~3,500–4,000 killed; 200,000 Jews flee within a year' },
      { year: 1911, label: 'Triangle Shirtwaist fire kills 146 garment workers, mostly Jewish immigrant women; spurs labor movement' },
      { year: 1917, label: 'Balfour Declaration: Britain endorses "a national home for the Jewish people" in Palestine; Pale of Settlement abolished by Russian Provisional Government' },
      { year: 1924, label: 'Johnson-Reed Immigration Act: Eastern European quotas slashed; mass Jewish immigration to the US effectively ends' },
    ],
    notableFigures: [
  ...
  },
  {
    ...
    longDescription: 'The seven decades since Israel\'s founding have been defined by extraordinary ingathering and equally extraordinary geopolitical transformation. Operation Magic Carpet (1949–1950) airlifted virtually the entire Yemenite Jewish community to Israel. Waves of Jews from Iraq, Morocco, Tunisia, Libya, and Egypt followed through the 1950s–1970s as Arab nationalism made Jewish life untenable across the Middle East. Meanwhile in the USSR, Stalin waged war on Jewish culture: in 1948 he dissolved the Jewish Anti-Fascist Committee and murdered its leader; in 1952 he ordered the execution of 13 leading Yiddish writers on the "Night of the Murdered Poets"; in 1953 the fabricated "Doctors\' Plot" accused Jewish physicians of murder — a prelude to mass deportations that only Stalin\'s death prevented. The Six-Day War of 1967 transformed world Jewish identity and ignited the Soviet Jewry movement, in which diaspora communities campaigned for the right of Soviet Jews to emigrate. "Refuseniks" — those denied exit visas — became international symbols. The movement culminated in over a million emigrants after the USSR\'s collapse (1990–2000). Operation Solomon (1991) airlifted the Beta Israel community from Ethiopia in 36 hours. Today Israel\'s 7.2 million Jews live alongside a diaspora of roughly equal size — concentrated in the United States (6 million), France (500,000), Canada, Argentina, and the UK.',
    keyEvents: [
      { year: 1948, label: 'Operation Magic Carpet begins airlifting 49,000 Yemenite Jews to Israel; Stalin dissolves the Jewish Anti-Fascist Committee and murders its leader' },
      { year: 1952, label: '"Night of the Murdered Poets": Stalin executes 13 leading Yiddish writers and cultural figures on a single night (August 12)' },
      { year: 1953, label: 'Doctors\' Plot: Stalin accuses Jewish doctors of murder conspiracy; Stalin dies (March 5) before planned deportations begin' },
      { year: 1967, label: 'Six-Day War; Israel captures Jerusalem; worldwide Jewish pride renews — and Soviet Jews begin demanding the right to emigrate' },
      { year: 1973, label: 'Yom Kippur War; Egypt and Syria launch surprise attack; Israel survives at great cost' },
      { year: 1970, label: 'Leningrad hijacking trial: Refuseniks\' death sentences draw global outrage; Soviet emigration opens; 291,000 Jews leave 1970–1988' },
      { year: 1991, label: 'Operation Solomon: 14,325 Ethiopian Jews airlifted to Israel in 36 hours; Soviet collapse enables ~1 million Jews to emigrate 1990–2000' },
